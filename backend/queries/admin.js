...
const createModeratorQuery = `INSERT INTO Moderator (name, email, password, admin_id) VALUES ($1, $2, $3, $4)`;
...
const updateUserStatusQuery = `UPDATE Users SET status = $1 WHERE user_id = $2`;

const updateModeratorStatusQuery = `UPDATE Moderator SET status = $1 WHERE moderator_id = $2`;

const deleteUserQuery = `DELETE FROM Users WHERE user_id = $1`;

const deleteModeratorQuery = `DELETE FROM Moderator WHERE moderator_id = $1`;
